...
if("TRUE" STREQUAL "TRUE")
  set(mobot_urdf_SOURCE_PREFIX /home/dsb86/ros_ws/src/learning_ros/Part_2/mobot_urdf)
  set(mobot_urdf_DEVEL_PREFIX /home/dsb86/ros_ws/devel)
  ...
  set(mobot_urdf_INSTALL_PREFIX /home/dsb86/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mobot_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dsb86/ros_ws/src/learning_ros/Part_2/mobot_urdf/${idir}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
    endif()
